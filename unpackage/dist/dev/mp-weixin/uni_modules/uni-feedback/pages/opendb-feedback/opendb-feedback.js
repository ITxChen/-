...
if (!Array) {
  ...
  (_easycom_uni_forms_item2 + _component_uni_file_picker + _easycom_uni_easyinput2 + _easycom_uni_forms2 + _component_uni_fab)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    n: common_vendor.sr("form", "4655c932-0"),
    o: common_vendor.p({
      value: $data.formData,
      ["validate-trigger"]: "submit",
      ["err-show-type"]: "toast"
    }),
    p: common_vendor.sr("fab", "4655c932-8"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Hbuilder/Blogger/uni_modules/uni-feedback/pages/opendb-feedback/opendb-feedback.vue"]]);
