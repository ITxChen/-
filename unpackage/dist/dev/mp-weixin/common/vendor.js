...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.56.1",\n        "192.168.78.1",\n        "192.168.111.1",\n        "192.168.43.172"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/Hbuilder/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"dcloud","spaceId":"mp-22bd1b8a-06e0-4572-9244-a4f4f8e44150","clientSecret":"bWD/Bhaqu+4HUbJEOIT6hw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__75106CD";
} catch (e2) {
