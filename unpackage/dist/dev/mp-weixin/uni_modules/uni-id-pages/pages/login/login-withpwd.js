...
const _sfc_main = {
  ...
  methods: {
    ...
    pwdLogin() {
      ...
      common_vendor.index.setStorageSync("username", this.username).then((res) => {
        console.log(res);
      });
    },
    /* 前往注册 */
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-58ed63b0"], ["__file", "D:/Hbuilder/Blogger/uni_modules/uni-id-pages/pages/login/login-withpwd.vue"]]);
